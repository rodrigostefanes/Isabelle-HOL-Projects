...
next
  ...
  next
    ...
    proof -
      ...
      have 4: "unrank_cond1 (rank xs qs) qs" using 3 and Cons.IH and Cons.prems(1) by presburger
      ...
      have 16: "unrank_cond (rank (x#xs) (q#qs)) (q#qs)" using 2 and 15  by simp
      show ?case using 16 by simp
      qed
    qed
qed
